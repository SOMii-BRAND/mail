...
try:
  if os.name=='nt':
   ...
   os.system('clear')
    ...
    print("\033[91mERROR :| \nConatct SOMI-TN AS u LIKE !\033[00m")
...
def aron():
 try:
  if os.name=='nt':
   os.system('cls && cd SMTP-Mail.acess-Cracker-Checker && Somi.py')
  else:
   os.system('clear && cd SMTP-Mail.acess-Cracker-Checker && python2 Somi.py')
 except:
    print("\033[91mERROR :| \nConatct SOMI-BRAND AS u LIKE !\033[00m")
to_check={}
...
<body>
	<center>
		...
		<font color="#f16f6f"><h1>[ ! ]Developped by SOMU-TN [ ! ]</h1></font><br><br><br>
		...
		<font color="black" size="5" ><font color="red">Facebook :</font> <a href="https://www.facebook.com/amir.othman.official">Click HEre</a> <br><br></font>
...
\033[1;91m╚═════╝░░╚════╝░╚═╝░░░░░╚═╝╚═╝
               ...
               \033[91m[\033[92m+\033[91m]\033[1m(C)opyright > Github.com/SOMI190\033[91m [\033[92m+\033[91m]
              \033[91m[\033[92m+\033[91m]\033[95m SMTP CRACKER V2.1 DEV BY SOMI \033[91m[\033[92m+\033[91m]
             \033[91m[\033[92m+\033[91m]\033[92m   Mail : SOMIRAPPER@gmail.com  \033[91m[\033[92m+\033[91m]
            \033[91m[\033[92m+\033[91m]\033[94m Facebook > Fb.com/SO MUSICAN official \033[91m[\033[92m+\033[91m]
           \033[91m[\033[92m+\033[91m]   Youtube > youtube.com/Somi brand \033[91m[\033[92m+\033[91m]''')
